...
def main():
    ...
    print("")
    print("🔧 HOW IT WORKS:")
    print("• No API-level filtering: Retrieves all users from Graph API")
    print("• Client-side filtering: Only filters by mail address presence")
    print("• Validation via validate_user_mailbox(): Uses /mailboxSettings and /messages endpoints")
    print("• RBAC compliant: Follows Microsoft's recommended approach for mailbox verification")
    print("• Focus on mailbox validation: Uses proper Graph API endpoints instead of account status")
    print("")
    print("🚀 USAGE:")
    ...
    print("• Users without email addresses - mail = null (client-side only)")
    print("• Focus ONLY on users with mail addresses for preliminary filtering")
    print("• Full validation via validate_user_mailbox() for actual mailbox verification")
    print("")
    print("🔍 VALIDATION METHOD:")
    print("• Primary: Uses Microsoft Graph /mailboxSettings endpoint")
    print("• Fallback: Uses /messages endpoint if needed")
    print("• Detects ErrorMailboxNotEnabled and MailboxNotEnabledForRESTAPI")
    print("• No accountEnabled checks - pure mailbox validation approach")
    print("")
    print("⚠️  APPROACH:")
    print("• Single-stage filtering: Only filters by mail address presence")
    print("• No API filtering: Retrieves all users, filters client-side")
    print("• Mailbox validation: Uses validate_user_mailbox() for accurate verification")
